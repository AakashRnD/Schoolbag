...
//        addPreferencesFromResource(R.xml.pref_data_sync);
		...
		bindPreferenceSummaryToValue(findPreference("medium_list"));
		bindPreferenceSummaryToValue(findPreference("board_list"));
		bindPreferenceSummaryToValue(findPreference("std_list"));
		Preference about_screen=findPreference("about_screen");
		about_screen.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener(){
			public
			boolean onPreferenceClick(Preference preference){
				Intent viewIntent=new Intent(Settings.this,About.class);
...
//        bindPreferenceSummaryToValue(findPreference("sync_frequency"));
	 ...
	 */
	private static
	boolean isSimplePreferences(Context context){
